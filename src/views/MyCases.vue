<template>
  <div class="q-pa-md q-col-gutter-y-sm">
    <q-card flat bordered class="my-card">
      <q-card-section>
        <div class="text-h6">{{t('person.MysolveCase')}}</div>
      </q-card-section>
      ...
      <q-card-section class="q-pt-none">
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            <div class="q-pa-md" style="max-width: 450px" >
              <q-list bordered padding>
                ...
                <q-item clickable @click="category='07-012'">
                ...
                <q-item clickable @click="category='07-013'">
                  <q-item-section avatar>
                    <q-avatar square>
                ...
                <q-item clickable @click="category='07-014'">
                  <q-item-section avatar>
                    <q-avatar square>
                ...
                <q-item clickable @click="category='07-015'">
                  <q-item-section avatar>
                    <q-avatar square>
                ...
                <q-item clickable @click="category='07-015'">
                  ...
                  <q-item-section>{{t('project.oralPathology')}}</q-item-section>
                </q-item>
          ...
          <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
            <SolveCase :category="category" :criterio="criterio" :title="t('person.MysolveCase')"></SolveCase>
          </div>
        </div>
      </q-card-section>
    </q-card>
...
import SolveCase from "../components/SolveCase.vue";
Loading.show()
Loading.show({
...
export default {
  components:{SolveCase},
  setup: function() {
    const category = ref('');
    const criterio = ref('completed');
    const $q = useQuasar();
