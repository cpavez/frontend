<template>
  <div class="q-pa-md q-col-gutter-y-sm">
    <q-card flat bordered class="my-card">
      <q-card-section>
        <div class="text-h6">{{t('person.trackingCase')}}</div>
      </q-card-section>
      ...
      <q-card-section class="q-pt-none">
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
            <SolveCaseAll :category="category" :criterio="criterio" :title="t('person.trackingCase')"></SolveCaseAll>
          </div>
        </div>
      </q-card-section>
    </q-card>
...
import SolveCaseAll from "../components/SolveCaseAll.vue";
Loading.show()
Loading.show({
