...
void store.dispatch(
  "questionnaire/setQuestionnaireAntecedentes",
  props.questionnaireId
);
const questionnaireAntecedentes = computed(
  () => store.getters["questionnaire/getQuestionnaireAntecedetes"]
);
    ...
    <q-card-section horizontal>
      <q-card-section class="col-12">
        <Questionnaire
          ...
          :questionnaire="questionnaireAntecedentes"
          :modelValue="formData"
