...
void store.dispatch('questionnairePatient/setQuestionnaireInterconsultaDermatologia',props.questionnaireId);
const questionnaireInterconsultaDermatologia = computed(()=>store.getters['questionnairePatient/getQuestionnaireInterconsultaDermatologia']);
  ...
  <q-card class="my-card q-mb-sm" flat bordered>
    <q-item>
      <q-item-section>
        ...
        <q-item-label caption>
          Detalle lo mas posible todo los datos de la Interconsulta de Dermatología
        </q-item-label>
      </q-item-section>
    </q-item>
    ...
    <q-card-section horizontal>
      <q-card-section class="col-12">
        <Questionnaire :status="status"  :observationResource="observationResource"  :questionnaire="questionnaireInterconsultaDermatologia" :modelValue="formData" @update:modelValue="newValue => formData = newValue" :questionnaireId="questionnaireId" :patientId="patientId" :questionnaireResponse="questionnaireResponse"/>
      </q-card-section>
    </q-card-section>
  </q-card>
</template>
